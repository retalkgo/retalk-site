...
<Tabs items={['通过CDN', '通过NPM']}>
    <Tab>
        ```html
        <script src="https://cdn.jsdelivr.net/npm/retalk@latest/dist/retalk.js">
        <script src="https://cdn.jsdelivr.net/npm/retalk@latest/dist/retalk.css">
        ```
        <Callout type="warning">
                Jsdelivr在部分地区的访问速度并不理想，我们建议您通过Jsdelivr镜像或其他NPM CDN引入静态资源。
        </Callout>
    </Tab>
    <Tab>
        ```bash
